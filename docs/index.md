...
features:
  ...
  - title: 🤖 AI 智能助理 (Pro)
    details: 对话式文件管理，13 个工具链自动调度，用大白话下指令完成文件归类、清理、搜索、设闹钟、建日程等复杂任务。
---
...
<tr><td>📅 日程管理</td><td>"明天下午 3 点提醒我开会，提前 15 分钟提醒"</td></tr>
<tr><td>⏰ 闹钟定时</td><td>"设一个每天早上 7 点的闹钟"</td></tr>
<tr><td>🚀 快捷操作</td><td>"打开微信" / "帮我打开 WiFi 设置"</td></tr>
