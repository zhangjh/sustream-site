...
<div style="text-align: center; padding: 2rem 1rem;">
  ...
  <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap; margin-top: 1.5rem;">
    <img src="/首页.webp" alt="素流主界面" style="width: 160px; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.1);" />
    <img src="/语义搜索.webp" alt="语义搜索" style="width: 160px; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.1);" />
    <img src="/Agent.webp" alt="AI 助理" style="width: 160px; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.1);" />
    <img src="/智能清理.webp" alt="智能清理" style="width: 160px; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.1);" />
  </div>
